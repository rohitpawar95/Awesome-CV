...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Developed License Plate Recognition System using Machine Learning, Python \& OpenCv}
        \item {Developed SOAP-client in C language}
        \item {Implemented Face Recognition using Machine Learning, Python \& OpenCv}
        \item {Implemented REST API's in Ruby On Rails}
        \item {Implemented AWS EC2 cli automation using bash script}
        \item {Developed REST API client in Go language}
        \item {Chef, Ansible \& Puppet configuration managers orchestration using Rails }
        \item {Migrate VMware vSphere VM in Azure Cloud Platform}
      \end{cvitems}
    }
